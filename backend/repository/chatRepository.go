...
func (repository *ChatRepository) Save(ctx context.Context, chat domain.Chat) (int64, error) {
	var id int64
...
func (repository *ChatRepository) GetPreviewGroupChats(ctx context.Context, userEmail string) ([]web.PreviewGroupChat, error) {
...
func (repository *ChatRepository) GetPreviewPersonalChats(ctx context.Context, userEmail string) ([]web.PreviewPersonalChat, error) {
...
func (repository *ChatRepository) GetPersonalChats(ctx context.Context, userEmail1 string, userEmail2 string) ([]domain.Chat, error) {
...
func (repository *ChatRepository) GetGroupChats(ctx context.Context, groupId int64) ([]domain.Chat, error) {
	var chats []domain.Chat
